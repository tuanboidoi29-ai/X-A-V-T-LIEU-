...
2. Chọn file `TT-pro-1.0.14.rbz`.

Có thể cài riêng từng chức năng bằng các file `TT-pro-XoaVatLieu-1.0.14.rbz`, `TT-pro-VeVan-1.0.14.rbz` hoặc `TT-pro-CapNhat-1.0.14.rbz`. Gói `TT-pro-1.0.14.rbz` là bản tổng hợp.
